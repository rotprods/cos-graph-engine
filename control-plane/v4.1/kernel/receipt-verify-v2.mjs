...
function validateModel(model) {
  eq(model.schemaVersion, 2, 'MODEL_SCHEMA');
  eq(model.contractId, 'cos_repo_assurance_v4_1_receipt_kernel', 'MODEL_ID');
  eq(model.version, '4.1.0-alpha.5', 'MODEL_VERSION');
  ...
  const required = [
    ...
    'EVENT_GENESIS_SEGMENT_FORBIDS_ANCHOR','SUPERSESSION_GRAPH_ACYCLIC',
