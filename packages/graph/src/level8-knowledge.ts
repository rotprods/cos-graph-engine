...
export class KnowledgeGraphEngine {
  ...
  buildCOS() {
    ...
    this.addEntity({ id: 'cos-api', name: 'API', type: 'system' });
    this.addEntity({ id: 'cos-infra', name: 'Infrastructure', type: 'system' });
    ...
    this.addRelation({ id: generateId(), source: 'cos', target: 'cos-infra', type: 'has' });
  }
