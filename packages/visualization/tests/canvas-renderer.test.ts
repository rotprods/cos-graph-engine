...
import { QuadTree, CanvasGraphRenderer, Point } from '../src/canvas-renderer';
...
{
  const qt = new QuadTree({ x: 0, y: 0, width: 800, height: 600 });
...

{
  ...
  const renderer = new CanvasGraphRenderer(800, 600);
