        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {LEVELS.map((l) => {
              ...
              return (
                <div key={l.level} className={`level-card rounded-lg border ${colors[idx]} ${bgColors[idx]} p-4`}>
      ...
      <section id="features" className="border-t border-surface-800 py-24 px-6">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {FEATURES.map((f) => (
              <div key={f.title} className="rounded-lg border border-surface-800 bg-surface-800/30 p-5 hover:border-surface-700 transition-colors">
