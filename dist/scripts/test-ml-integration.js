...
const ml_integration_1 = require("../packages/graph/src/ml-integration");
let passed = 0;
let failed = 0;
...
async function main() {
    ...
    const classifier = new ml_integration_1.EmbeddingClassifier(['cat', 'dog']);
    ...
    const embed = new level10_embedding_1.EmbeddingGraph();
    ...
    const reRanker = new ml_integration_1.GraphRAGNeuralReRanker(0.5);
    ...
    const pipeline = new ml_integration_1.MLPipeline(['relevant', 'irrelevant']);
...
//# sourceMappingURL=test-ml-integration.js.map