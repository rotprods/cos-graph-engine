...
const automl_1 = require("../packages/graph/src/automl");
let passed = 0;
let failed = 0;
...
async function main() {
    ...
    const searcher = new automl_1.ArchitectureSearch();
    ...
    const optimizer = new automl_1.HyperParameterOptimizer();
    ...
    const pipeline = new automl_1.AutoMLPipeline();
...
//# sourceMappingURL=test-automl.js.map