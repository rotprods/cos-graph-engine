...
const pipeline_l16l17l18l19_1 = require("../packages/graph/src/pipeline-l16l17l18l19");
...
(function testPipelineCreation() {
    console.log('\n=== Pipeline Creation ===');
    const pipe = new pipeline_l16l17l18l19_1.PipelineL16L17L18L19();
    assert(pipe instanceof pipeline_l16l17l18l19_1.PipelineL16L17L18L19, 'Pipeline instantiated');
    assert(pipe.networkGraph instanceof level16_network_1.NetworkGraphEngine, 'Has L16 Network');
    assert(pipe.socialGraph instanceof level17_social_1.SocialGraphEngine, 'Has L17 Social');
    assert(pipe.biologicalGraph instanceof level18_biological_1.BiologicalGraphEngine, 'Has L18 Bio');
    assert(pipe.molecularGraph instanceof level19_molecular_1.MolecularGraphEngine, 'Has L19 Molecular');
})();
...
(function testAccessors() {
    ...
    assert(pipe.getNetworkGraph() instanceof level16_network_1.NetworkGraphEngine, 'Access: getNetworkGraph');
    assert(pipe.getSocialGraph() instanceof level17_social_1.SocialGraphEngine, 'Access: getSocialGraph');
    assert(pipe.getBiologicalGraph() instanceof level18_biological_1.BiologicalGraphEngine, 'Access: getBiologicalGraph');
    assert(pipe.getMolecularGraph() instanceof level19_molecular_1.MolecularGraphEngine, 'Access: getMolecularGraph');
})();
...
if (f > 0)
    process.exit(1);
//# sourceMappingURL=test-pipeline-l16171819.js.map