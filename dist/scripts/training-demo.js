...
async function main() {
    ...
    const cell = new (class extends BaseCell {
        constructor() {
            super({
                id: 'cos:training:cell', name: 'training-processor',
    ...
    for (let i = 0; i < tasks.length; i++) {
        ...
        const quality = output.result?.quality || output.confidence;
        scores.push(quality);
        ...
        if ((i + 1) % 5 === 0 || i === tasks.length - 1) {
            ...
            if (i === 4)
                baselineScore = avgScore; // baseline after first 5
        }
        // Show progress
...
//# sourceMappingURL=training-demo.js.map