...
const visualizer_1 = require("../packages/graph/src/visualizer");
...
async function main() {
    ...
    const html = (0, visualizer_1.generateVisualizer)(['L0', 'L1']);
    ...
    const result = (0, visualizer_1.generateVisualizerFile)(outPath, ['L0', 'L1', 'L2']);
    ...
    const htmlAll = (0, visualizer_1.generateVisualizer)();
...
//# sourceMappingURL=test-cli-visualizer.js.map