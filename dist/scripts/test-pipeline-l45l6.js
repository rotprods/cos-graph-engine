...
const pipeline_l4l5l6_1 = require("../packages/graph/src/pipeline-l4l5l6");
...
{
    const pipeline = new pipeline_l4l5l6_1.PipelineL4L5L6();
...
console.log('\n=== Test 9: Timing options ===');
{
    ...
    const pipeline1 = new pipeline_l4l5l6_1.PipelineL4L5L6();
    ...
    const pipeline2 = new pipeline_l4l5l6_1.PipelineL4L5L6();
...
//# sourceMappingURL=test-pipeline-l45l6.js.map