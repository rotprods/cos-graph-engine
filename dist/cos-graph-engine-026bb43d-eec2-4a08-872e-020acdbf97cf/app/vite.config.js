...
const vite_1 = require("@tanstack/react-start/plugin/vite");
const vite_2 = __importDefault(require("@tailwindcss/vite"));
const plugin_react_1 = __importDefault(require("@vitejs/plugin-react"));
const vite_3 = require("./src/module/design-inspector/vite");
const vite_plugin_svgr_1 = __importDefault(require("vite-plugin-svgr"));
const vite_4 = require("vite");
...
const QUANTA_ICONS_SHIM = (0, node_url_1.fileURLToPath)(new URL("./src/lib/quanta-material-icons.ts", import.meta.url));
exports.default = (0, vite_4.defineConfig)(({ mode }) => {
    ...
    return {
        ...
        plugins: [
            ...
            (0, vite_1.tanstackStart)({
                server: { entry: "server" },
            }),
            (0, vite_3.higgsfieldDesignInspectorVitePlugin)(designInspectorEnabled),
            (0, plugin_react_1.default)({
                babel: {
                    plugins: designInspectorEnabled ? [vite_3.higgsfieldDesignSourceBabelPlugin] : [],
                },
            }),
            (0, vite_2.default)(),
