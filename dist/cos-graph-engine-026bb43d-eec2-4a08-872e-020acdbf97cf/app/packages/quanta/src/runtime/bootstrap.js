...
function bootstrapScript({ brand = 'default', storageKey = storage_keys_ts_1.DEFAULT_STORAGE_KEY, overrideStorageKey = storage_keys_ts_1.DEFAULT_OVERRIDE_STORAGE_KEY, themesStorageKey = storage_keys_ts_1.DEFAULT_THEMES_STORAGE_KEY, } = {}) {
    return `(function () {
