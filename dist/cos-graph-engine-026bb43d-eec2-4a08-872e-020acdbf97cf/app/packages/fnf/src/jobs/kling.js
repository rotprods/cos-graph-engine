...
exports.klingVideo = exports.KLING_DEFAULT_MOTION_ID = exports.KlingModel = void 0;
 ...
 */
exports.KLING_DEFAULT_MOTION_ID = '7077cde8-7947-46d6-aea2-dbf2ff9d441c';
 ...
 */
exports.klingVideo = (0, define_job_1.defineJob)({
    jobSetType: 'kling',
    outputType: 'video',
    params: {
        prompt: true,
        ...
        settings: {
            model: z_1.z._default(z_1.z.enum(Object.values(exports.KlingModel)), exports.KlingModel.v2_5Turbo),
            ...
            cameraControl: z_1.z.wire('camera_control', z_1.z._default(z_1.z.nullable(z_1.z.string()), null)),
            // The wire always carries a motion_id; the sentinel means "no preset"
            // (mapKlingParams: preset_id ?? defaultKlingPresetId).
            motionId: z_1.z.wire('motion_id', z_1.z._default(z_1.z.nullable(z_1.z.string()), exports.KLING_DEFAULT_MOTION_ID)),
            duration: z_1.z.duration({ values: [5, 10] }),
            /** Fallback for width/height when the start image's size is unknown locally. */
            aspectRatio: z_1.z.wire('aspect_ratio', z_1.z._default(z_1.z.string(), '16:9')),
        },
    },
    validate: ({ prompt, media, settings }) => {
        ...
        const issues = raw.length >= MAX_PROMPT_CHARACTERS
            ...
            : [];
        issues.push(...(0, checks_1.oneOf)('duration', settings.duration, [5, 10]));
        ...
        const textOnlyAllowed = settings.model === exports.KlingModel.v2_5Turbo && settings.resolution === '1080p';
        if ((0, checks_1.countRefs)(media, 'input_image') === 0 && !textOnlyAllowed)
    ...
    finalize: (wire, input) => {
        ...
        const motionId = wire.motion_id ?? exports.KLING_DEFAULT_MOTION_ID;
        ...
        const measured = (0, dimensions_1.firstSizeMeta)(input.media, ['input_image']);
        const box = (0, dimensions_1.aspectRatioDimensions)(wire.aspect_ratio, 720);
        ...
        const wireRatio = KLING_WIRE_RATIOS.has(aspect_ratio) ? { aspect_ratio } : {};
        return {
            ...rest,
            ...wireRatio,
            ...
            mode: model !== exports.KlingModel.v2_1Master ? (resolution === '1080p' ? 'pro' : 'std') : 'std',
            ...
            enhance_prompt: motionId !== exports.KLING_DEFAULT_MOTION_ID
                ? true
    ...
    restore: (wire) => {
        ...
        if (wire.aspect_ratio == null && typeof wire.width === 'number' && typeof wire.height === 'number' && wire.height > 0)
            return { aspect_ratio: (0, dimensions_1.simplifyRatio)(wire.width, wire.height) };
        return {};
    },
});
