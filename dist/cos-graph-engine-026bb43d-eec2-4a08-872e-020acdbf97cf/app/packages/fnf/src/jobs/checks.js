...
function intRange(field, value, min, max) {
...
function promptRequired(prompt, min = 1) {
...
function promptMax(prompt, max, opts = {}) {
    const raw = prompt?.instruction ?? '';
