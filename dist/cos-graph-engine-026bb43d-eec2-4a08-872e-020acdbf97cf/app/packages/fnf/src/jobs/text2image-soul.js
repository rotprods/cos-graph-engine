...
exports.textToImageSoul = exports.DEFAULT_SOUL_STYLE_ID = void 0;
 ...
 */
exports.DEFAULT_SOUL_STYLE_ID = '464ea177-8d40-4940-8d9d-b438bab269c7';
/**
 ...
 */
exports.textToImageSoul = (0, define_job_1.defineJob)({
    ...
    params: {
        ...
        settings: {
            ...
            styleId: z_1.z.wire('style_id', z_1.z._default(z_1.z.nullable(z_1.z.string()), exports.DEFAULT_SOUL_STYLE_ID)),
            customReferenceId: z_1.z.wire('custom_reference_id', z_1.z.optional(z_1.z.nullable(z_1.z.string()))),
            customReferenceStrength: z_1.z.wire('custom_reference_strength', z_1.z.optional(z_1.z.nullable(z_1.z.number()))),
            steps: z_1.z._default(z_1.z.number(), 50),
            ...
            aspectRatio: z_1.z.wire('aspect_ratio', z_1.z._default(z_1.z.string(), '3:4')),
            /** Diffusion sampler shift; the product derives 3 (720p) / 4 (1080p) when unset. */
            sampleShift: z_1.z.wire('sample_shift', z_1.z.optional(z_1.z.number())),
            sampleGuideScale: z_1.z.wire('sample_guide_scale', z_1.z._default(z_1.z.number(), 4)),
        },
    },
    ...
    validate: ({ settings }) => {
        const issues = [
            ...(0, checks_1.intRange)('steps', settings.steps, 1, 50),
    ...
    finalize: (wire) => {
        ...
        if (!row[ratio]) {
            ...
            if (parsed)
                ratio = (0, dimensions_1.closestRatioBySize)(Object.keys(row), { width: Number(parsed[1]), height: Number(parsed[2]) });
        }
        ...
        const styleId = wire.style_id ?? exports.DEFAULT_SOUL_STYLE_ID;
        const enhance = wire.image_reference != null
            ? false
            : styleId !== exports.DEFAULT_SOUL_STYLE_ID ? true : wire.enhance_prompt ?? true;
        return {
            ...wire,
...
//# sourceMappingURL=text2image-soul.js.map