 ...
 * fallback vocabulary.
 */
export declare const REF_TYPE_BY_UPLOAD: Record<UploadType, string>;
 ...
 */
export type MediaSource = MediaBytes | {
    read: () => Promise<MediaBytes>;
};
/**
...
export interface MediaClient {
    ...
    uploadFromUrl: (input: Omit<UploadInput, 'source' | 'contentType'> & {
        url: string;
        maxBytes?: number;
