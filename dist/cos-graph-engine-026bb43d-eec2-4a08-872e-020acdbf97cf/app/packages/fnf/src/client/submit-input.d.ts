...
type InputOf<E> = E extends JobEntry<infer Type, infer Settings, infer Env> ? string extends Type ? GenerationInput : BaseSubmitFields & Env & {
    model: Type;
    settings: Settings;
} : never;
/**
...
export {};
//# sourceMappingURL=submit-input.d.ts.map