...
exports.mapProfileUser = mapProfileUser;
exports.mapProfileWorkspace = mapProfileWorkspace;
exports.mapProfileWorkspaces = mapProfileWorkspaces;
exports.mapProfileWallet = mapProfileWallet;
function mapProfileUser(raw) {
    if (!isRecord(raw))
        return null;
    return {
        id: str(raw.id) ?? '',
...
function mapProfileWorkspace(raw) {
    if (!isRecord(raw))
        return null;
...
function mapProfileWorkspaces(raw) {
