...
export type GenerationStatus = 'pending' | 'waiting' | 'queued' | 'in_progress' | 'ip_detect' | 'completed' | 'failed' | 'nsfw' | 'canceled' | 'ip_detected';
export declare const TERMINAL_STATUSES: ReadonlySet<GenerationStatus>;
