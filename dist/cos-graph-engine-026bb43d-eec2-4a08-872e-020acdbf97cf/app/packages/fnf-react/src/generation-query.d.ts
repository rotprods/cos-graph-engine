 ...
 */
export declare function generationQueryOptions(client: GenerationQueryClient, id: string, opts?: LiveQueryOptions): any;
//# sourceMappingURL=generation-query.d.ts.map