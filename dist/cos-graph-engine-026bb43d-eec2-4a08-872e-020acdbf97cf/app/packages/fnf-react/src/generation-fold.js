...
exports.foldGeneration = foldGeneration;
 ...
 */
function foldGeneration(prev, next) {
    if (!prev || prev.id !== next.id)
        return next;
    if ((0, client_1.isTerminalJobStatus)(prev.status) && !(0, client_1.isTerminalJobStatus)(next.status))
...
//# sourceMappingURL=generation-fold.js.map