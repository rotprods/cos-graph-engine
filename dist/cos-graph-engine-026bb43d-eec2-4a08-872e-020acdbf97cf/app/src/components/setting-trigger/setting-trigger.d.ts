...
export declare function SettingTrigger({ label, children, placeholder, start, end, render, className, ref, ...props }: SettingTriggerProps): any;
//# sourceMappingURL=setting-trigger.d.ts.map