...
exports.makeInitialItems = makeInitialItems;
exports.makeOlderBatch = makeOlderBatch;
/**
...
function makeVideo(index, groupId, groupLabel, rand) {
...
function makeInitialItems() {
    return exports.GROUPS.flatMap((group, gi) => makeBatch(group.id, group.label, group.count, 1000 + gi * 97, gi === 0));
}
/**
