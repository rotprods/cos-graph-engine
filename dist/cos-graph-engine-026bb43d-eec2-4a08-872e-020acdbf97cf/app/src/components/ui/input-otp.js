...
const remove_svg_react_1 = __importDefault(require("@material-symbols/svg-400/outlined/remove.svg?react"));
...
const InputOTPSlot = React.forwardRef(({ index, className, ...props }, ref) => {
    ...
    return (<div ref={ref} className={(0, utils_1.cn)("relative flex h-9 w-9 items-center justify-center border-y border-r border-input text-sm shadow-sm transition-all first:rounded-l-md first:border-l last:rounded-r-md", isActive && "z-10 ring-1 ring-ring", className)} {...props}>
      {char}
