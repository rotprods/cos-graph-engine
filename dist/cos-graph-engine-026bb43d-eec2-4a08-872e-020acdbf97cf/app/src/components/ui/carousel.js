...
const arrow_back_svg_react_1 = __importDefault(require("@material-symbols/svg-400/outlined/arrow_back.svg?react"));
const arrow_forward_svg_react_1 = __importDefault(require("@material-symbols/svg-400/outlined/arrow_forward.svg?react"));
...
const CarouselPrevious = React.forwardRef(({ className, variant = "outline", size = "icon", ...props }, ref) => {
    ...
    return (<button_1.Button ref={ref} variant={variant} size={size} className={(0, utils_1.cn)("absolute  h-8 w-8 rounded-full", orientation === "horizontal"
        ...
        <arrow_back_svg_react_1.default className="h-4 w-4"/>
...
const CarouselNext = React.forwardRef(({ className, variant = "outline", size = "icon", ...props }, ref) => {
    ...
    return (<button_1.Button ref={ref} variant={variant} size={size} className={(0, utils_1.cn)("absolute h-8 w-8 rounded-full", orientation === "horizontal"
        ...
        <arrow_forward_svg_react_1.default className="h-4 w-4"/>
