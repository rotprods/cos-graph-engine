...
{
    const p = new profiler_1.Profiler();
...
{
    const a = profiler_1.NoopProfiler.instance;
    const b = profiler_1.NoopProfiler.instance;
...
section('ProfilingHookImpl — CSR integration');
{
    ...
    const hook = new profiler_1.ProfilingHookImpl();
...
{
    const a = profiler_1.NoopProfilingHook.instance;
    const b = profiler_1.NoopProfilingHook.instance;
    assert(a === b, 'singleton: same instance');
    // Noop operations should not throw
