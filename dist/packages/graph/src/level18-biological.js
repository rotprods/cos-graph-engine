...
exports.BiologicalGraphEngine = void 0;
const core_1 = require("@cos/core");
class BiologicalGraphEngine {
    graph;
    adj = new Map();
    constructor(name = 'Biological Network') {
    ...
    simulateFiring(startNodeId, iterations = 5) {
        this.buildAdjacency();
        const fired = [];
    ...
    static fromJSON(data) { const g = new BiologicalGraphEngine(data.name); g.graph = data; g.buildAdjacency(); return g; }
    toMermaid() {
...
exports.BiologicalGraphEngine = BiologicalGraphEngine;
//# sourceMappingURL=level18-biological.js.map