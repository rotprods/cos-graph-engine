...
11. **Ecosystem-aware development.** Cada proyecto es parte del ecosistema — registra deployments, verifica conexiones, referencia proyectos similares.
12. **Usa `hardness ecosystem`** antes de cada sesión para sincronizar con el KG del Agentic OS.

## Comandos Ecosystem

| Comando | Descripción |
|---------|-------------|
| `hardness ecosystem summary` | Resumen completo del ecosistema |
| `hardness ecosystem search -q "<term>"` | Buscar proyectos |
| `hardness ecosystem clusters` | Listar clusters |
| `hardness ecosystem sync` | Sincronizar con Agentic OS KG |
| `hardness qa --ecosystem` | QA con checks de ecosistema |

## Data Flow Ecosystem

```
Agentic OS KG (L5) ←→ hardness ecosystem sync ←→ .hardness/ecosystem-cache.json
       ↕                        ↕
  31 proyectos            QA / Pipeline / Style
  4 clusters              modules
  ~318K LOC
```