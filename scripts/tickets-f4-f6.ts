...
export const TICKETS_FASE4 = [
  {
    id: 'T-4.1', titulo: 'Conectar L7 al Shared Memory Bus', fase: 4, nivel: 'L7',
    tipo: 'feature' as const, prioridad: 'P0' as const, estimacion: 8,
  ...
  },
  {
    ...
    tipo: 'testing' as const, prioridad: 'P0' as const, estimacion: 8,
  ...
  },
  {
    ...
    tipo: 'feature' as const, prioridad: 'P1' as const, estimacion: 4,
  ...
  },
  {
    ...
    tipo: 'documentation' as const, prioridad: 'P2' as const, estimacion: 4,
...
export const TICKETS_FASE5 = [
  {
    id: 'T-5.1', titulo: 'Mutation API L4-L6', fase: 5, nivel: 'L4-L6',
    tipo: 'feature' as const, prioridad: 'P0' as const, estimacion: 6,
  ...
  },
  {
    ...
    tipo: 'feature' as const, prioridad: 'P0' as const, estimacion: 12,
  ...
  },
  {
    ...
    tipo: 'feature' as const, prioridad: 'P1' as const, estimacion: 8,
  ...
  },
  {
    ...
    tipo: 'performance' as const, prioridad: 'P1' as const, estimacion: 12,
...
export const TICKETS_FASE6 = [
  {
    id: 'T-6.1', titulo: 'Tests L4 Call Graph', fase: 6, nivel: 'L4',
    tipo: 'testing' as const, prioridad: 'P2' as const, estimacion: 4,
  ...
  },
  {
    ...
    tipo: 'testing' as const, prioridad: 'P2' as const, estimacion: 12,
