...
import { errorCode } from '../control-plane/v4.1/kernel/receipt-canonical-v2.mjs';
import { validateModel } from '../control-plane/v4.1/kernel/receipt-verify-v2.mjs';
import { selfTests } from '../control-plane/v4.1/kernel/receipt-selftest-v2.mjs';

const MODEL='control-plane/v4.1/model/receipt-contract.v2.json';
async function main(){
