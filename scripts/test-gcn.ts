...
import { GCNLayer, GCN, GCNPipeline } from '../packages/graph/src/gcn';
...
const layer = new GCNLayer(4, 8, 'relu');
...
const tanhLayer = new GCNLayer(2, 3, 'tanh');
...
const gcn = new GCN({ hiddenDim: 8, numLayers: 2 });
...
const pipeline = new GCNPipeline({ hiddenDim: 4, numLayers: 2 });
